...
export function autoInjectNlsTagsIntoHtml(
  ...
  // 3. Activity Red Badges with explicit action guidance & evidence for each NLS/AI domain
  const act1Badge = `<div class="my-1.5 block border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20 leading-relaxed"><div class="flex flex-wrap items-center gap-2"><span class="text-red-600 font-bold">Tích hợp [NLS 1.1-a: Duyệt, tìm kiếm & lọc dữ liệu số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS sử dụng thiết bị số tra cứu tư liệu bối cảnh/tác giả liên quan)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 2.4-a: Hợp tác qua công nghệ số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS tương tác nhóm qua link học liệu trực tuyến Padlet/Drive)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 1.3-a: Quản lý & lưu trữ dữ liệu số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS lưu tệp dữ liệu vào thư mục bài học)</span></div></div>`;
  const act2Badge = `<div class="my-1.5 block border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20 leading-relaxed"><div class="flex flex-wrap items-center gap-2"><span class="text-red-600 font-bold">Tích hợp [NLS 3.1-a: Phát triển & chỉnh sửa nội dung số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS vẽ sơ đồ tư duy/slide thuyết trình kiến thức trọng tâm trên Canva/PowerPoint)</span> <span class="text-indigo-950 font-bold">Tích hợp [AI-NLc: Giao tiếp với AI & Prompt Engineering]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS đặt câu hỏi Prompt cho AI Gemini/ChatGPT để hỗ trợ gợi ý ý tưởng và phản biện)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 1.2-a: Đánh giá dữ liệu & thông tin số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: HS kiểm chứng thông tin từ AI với tài liệu SGK chính thống)</span></div></div>`;
  const act3Badge = `<div class="my-1.5 block border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20 leading-relaxed"><div class="flex flex-wrap items-center gap-2"><span class="text-red-600 font-bold">Tích hợp [NLS 2.4-a: Hợp tác qua công nghệ số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Các nhóm đồng chỉnh sửa bài tập luyện tập trên phiếu học tập số Google Docs)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 3.1-a: Phát triển & chỉnh sửa nội dung số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Soạn thảo bài làm chuẩn quy chuẩn kỹ thuật trình bày)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 4.1-a: Bảo vệ thiết bị & môi trường số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Tuân thủ quy tắc an toàn thông tin khi thao tác trực tuyến)</span></div></div>`;
  const act4Badge = `<div class="my-1.5 block border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20 leading-relaxed"><div class="flex flex-wrap items-center gap-2"><span class="text-red-600 font-bold">Tích hợp [NLS 5.3-a: Sử dụng sáng tạo công nghệ số & AI]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Ứng dụng công nghệ số tạo sản phẩm vận dụng sáng tạo)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 3.2-a: Chia sẻ nội dung & dữ liệu số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Đăng tải sản phẩm lên Padlet lớp và nhận xét chéo)</span> <span class="text-red-600 font-bold">Tích hợp [NLS 1.3-a: Quản lý & lưu trữ dữ liệu số]</span><span class="text-slate-700 font-normal italic text-[11px]">(Chỉ dẫn: Lưu trữ sản phẩm mở rộng vào kho lưu trữ số cá nhân)</span></div></div>`;
