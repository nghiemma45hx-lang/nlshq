...
2. TÍCH HỢP NLS TRỰC TIẾP VÀO MỤC TIÊU CÁC HOẠT ĐỘNG, NỘI DUNG/TỔ CHỨC THỰC HIỆN CỦA CÁC HOẠT ĐỘNG & NHIỆM VỤ NHÓM:
   ...
   - TẠI MỤC I. MỤC TIÊU BÀI HỌC CHÍNH: Bổ sung trực tiếp chỉ báo NLS (Tích hợp [NLS 1.1-a: Duyệt, tìm kiếm & lọc dữ liệu số], Tích hợp [NLS 2.4-a: Hợp tác qua công nghệ số]...) vào mục Năng lực số & Năng lực AI.
   - TẠI MỤC TIÊU TỪNG HOẠT ĐỘNG (Hoạt động 1, 2, 3, 4): BẮT BUỘC đóng gói toàn bộ các mã NLS/AI của mục tiêu hoạt động đó vào MỘT KHUNG ĐỎ NHỎ DUY NHẤT (border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20) nằm ngay dưới dòng "Mục tiêu:". Chữ ghi rõ "Tích hợp [NLS ...]" hoặc "Tích hợp [AI-NL...]":
     + Hoạt động 1: <div class="my-1.5 inline-flex items-center gap-2 border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20"><span class="text-red-600 font-bold">Tích hợp [NLS 1.1-a: Duyệt, tìm kiếm & lọc dữ liệu số]</span></div>
     + Hoạt động 2 (Chung 1 khung): <div class="my-1.5 inline-flex items-center gap-2 border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20"><span class="text-red-600 font-bold">Tích hợp [NLS 3.1-a: Phát triển & chỉnh sửa nội dung số]</span> <span class="text-indigo-950 font-bold">Tích hợp [AI-NLc: Giao tiếp với AI & Prompt Engineering]</span></div>
     + Hoạt động 3: <div class="my-1.5 inline-flex items-center gap-2 border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20"><span class="text-red-600 font-bold">Tích hợp [NLS 2.4-a: Hợp tác qua công nghệ số]</span></div>
     + Hoạt động 4: <div class="my-1.5 inline-flex items-center gap-2 border border-red-500 rounded px-2.5 py-1 text-xs font-mono font-bold bg-rose-50/20"><span class="text-red-600 font-bold">Tích hợp [NLS 5.3-a: Sử dụng sáng tạo công nghệ số & AI]</span></div>
   - TẠI PHẦN NỘI DUNG & TỔ CHỨC THỰC HIỆN CỦA CÁC HOẠT ĐỘNG (Cột 1 bên trái - Tổ chức thực hiện / các Bước 1, Bước 2, Bước 3): BẮT BUỘC chèn bổ sung miền NLS phù hợp (như "Tích hợp [NLS 1.1-a: Duyệt, tìm kiếm & lọc dữ liệu số]", "Tích hợp [NLS 3.1-a: Phát triển & chỉnh sửa nội dung số]") trực tiếp vào các bước tiến trình nội dung hoạt động dạy học.
